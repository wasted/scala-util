...
//def command(key: String, value: String): Future[IntegerRedisMessage] = send("command", key, value)
  ...
  def mGet(key: String, value: String): Future[IntegerRedisMessage] = send("mget", key, value)
  def mSet(key: String, value: String): Future[IntegerRedisMessage] = send("mset", key, value)
  def mSetNx(key: String, value: String): Future[IntegerRedisMessage] = send("msetnx", key, value)


  def sAdd(key: String, value: String): Future[IntegerRedisMessage] = send("sadd", key, value)
  def sCard(key: String, value: String): Future[IntegerRedisMessage] = send("scard", key, value)
  def sDiff(key: String, value: String): Future[IntegerRedisMessage] = send("sdiff", key, value)
  def sDiffStore(key: String, value: String): Future[IntegerRedisMessage] = send("sdiffstore", key, value)
  def sInter(key: String, value: String): Future[IntegerRedisMessage] = send("sinter", key, value)
  def sInterStore(key: String, value: String): Future[IntegerRedisMessage] = send("sinterstore", key, value)
  def sIsMember(key: String, value: String): Future[IntegerRedisMessage] = send("sismember", key, value)
  def sMembers(key: String, value: String): Future[IntegerRedisMessage] = send("smembers", key, value)
  def sMove(key: String, value: String): Future[IntegerRedisMessage] = send("smove", key, value)
  def sPop(key: String, value: String): Future[IntegerRedisMessage] = send("spop", key, value)
  def sRandMember(key: String, value: String): Future[IntegerRedisMessage] = send("srandmember", key, value)
  def sRem(key: String, value: String): Future[IntegerRedisMessage] = send("srem", key, value)
  def sUnion(key: String, value: String): Future[IntegerRedisMessage] = send("sunion", key, value)
  def sUnionStore(key: String, value: String): Future[IntegerRedisMessage] = send("sunionstore", key, value)
